...
static const int MBUS_LENGTH2_OFFSET = 2; // Offset of (duplicated) second length char
static const int MBUS_START2_OFFSET = 3; // Offset of (duplicated) second start char
